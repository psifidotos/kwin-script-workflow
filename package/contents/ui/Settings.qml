...
QtObject {
    ...
    property bool useCurrentActivityIcon: readConfig("UseCurrentActivityIcon", true)
    ...
    property bool triggerKWinScript: readConfig("TriggerKWinScript", true)
 ...
 /*   onLockActivitiesChanged: { writeConfig("LockActivities", lockActivities); }
    ...
    onTriggerKWinScriptChanged: { writeConfig("TriggerKWinScript", triggerKWinScript) ;}
   */
